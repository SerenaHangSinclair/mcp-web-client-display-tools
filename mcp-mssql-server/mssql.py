...
class MSSQLConnection:
    def __init__(self):
        ...
        self.host = os.getenv('MSSQL_HOST', 'localhost')
    ...
    # For connect with pymssql with database azure connection
    # @contextmanager
    ...
    def get_connection(self):
        ...
        # Check if server contains a named instance (has backslash)
        if '\\' in self.server:
            # Named instance - don't append port
            server = self.server
        else:
